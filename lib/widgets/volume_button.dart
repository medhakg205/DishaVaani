...
class _VolumeButtonState extends State<VolumeButton> {
  ...
  void _openSlider() {
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) => Stack(
        children: [
          Positioned.fill(
            child: GestureDetector(behavior: HitTestBehavior.translucent, onTap: _closeSlider),
          ),
                  ...
                  builder: (context, setPopupState) {
                    return Row(
                      children: [
                        ...
                        const Icon(Icons.volume_up, size: 14, color: AppColors.terracotta),
                      ],
                    );
                  },
                ),
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      link: _layerLink,
      child: IconButton(
        icon: Icon(_volume == 0 ? Icons.volume_off : Icons.volume_up, color: AppColors.terracotta),
